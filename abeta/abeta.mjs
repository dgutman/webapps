...
import { DSAUserInterface } from '../dsa/dsauserinterface_nonmodal.mjs';
import { ANNOTATION_TYPE, ANNOTATION_DESCRIPTION, CLASSES, HOTKEYS, ALLOW_ROI_CREATION, ENABLE_MODE_TOGGLE } from './annotationTool.config.mjs';

export function makeAbetaApp(editROIs) {
    // Removed ANNOTATION_TYPE and ANNOTATION_DESCRIPTION definitions
